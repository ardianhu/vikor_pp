<div>
        ...
        <div class="mb-5 flex items-center">
            ...
            <div class="flex-1 ml-10">
                ...
                <div x-data="{ bobot_jumlah_santri: 1 }" class="w-full">
                    ...
                    <div class="mt-4 flex items-center gap-x-2 w-full"> <label for="bobot_jumlah_santri" class="block text-gray-500">Bobot Jumlah Santri</label> <input type="number" id="inputBobotJumlahSantri" x-model="bobot_jumlah_santri" class="border border-gray-300 rounded-lg px-2 py-1 h-10 w-14 text-gray-700 outline-none focus:ring"> </div>
                </div> <!-- Ends component -->
            </div>
        </div>
        ...
        <div class="mb-5 flex items-center">
            ...
            <div class="flex-1 ml-10">
                ...
                <div x-data="{ bobot_biaya_bulanan: 1 }" class="w-full">
                    ...
                    <div class="mt-4 flex items-center gap-x-2 w-full"> <label for="bobot_biaya_bulanan" class="block text-gray-500">Bobot Biaya Bulanan</label> <input type="number" id="inputBobotBiayaBulanan" x-model="bobot_biaya_bulanan" class="border border-gray-300 rounded-lg px-2 py-1 h-10 w-14 text-gray-700 outline-none focus:ring"> </div>
                </div> <!-- Ends component -->
            </div>
        </div>
        ...
        <div class="mb-5 flex items-center">
            ...
            <div class="flex-1 ml-10">
                ...
                <div x-data="{ bobot_fasilitas: 1 }" class="w-full">
                    ...
                    <div class="mt-4 flex items-center gap-x-2 w-full"> <label for="bobot_fasilitas" class="block text-gray-500">Bobot Fasilitas</label> <input type="number" id="inputBobotFasilitas" x-model="bobot_fasilitas" class="border border-gray-300 rounded-lg px-2 py-1 h-10 w-14 text-gray-700 outline-none focus:ring"> </div>
                </div> <!-- Ends component -->
            </div>
        </div>
        ...
        <div class="mb-5 flex items-center">
            ...
            <div class="flex-1 ml-10">
                ...
                <div x-data="{ bobot_ekstrakurikuler: 1 }" class="w-full">
                    ...
                    <div class="mt-4 flex items-center gap-x-2 w-full"> <label for="bobot_ekstrakurikuler" class="block text-gray-500">Bobot Ekstrakurikuler</label> <input type="number" id="inputBobotEkstrakurikuler" x-model="bobot_ekstrakurikuler" class="border border-gray-300 rounded-lg px-2 py-1 h-10 w-14 text-gray-700 outline-none focus:ring"> </div>
                </div> <!-- Ends component -->
            </div>
        </div>

        <button type="submit" class="w-full bg-blue-600 text-white font-medium py-3 rounded-lg shadow hover:bg-blue-700 transition duration-200">Calculate VIKOR</button>
    </form>
    @if($results)
    ...
    @else
    <p class="text-gray-600 mt-4">No results available.</p>
    @endif
</div>
<script>
</script>